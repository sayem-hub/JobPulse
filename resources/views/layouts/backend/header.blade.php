<nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
    <div class="container-fluid"> <!--begin::Start Navbar Links-->
        ...
        <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
            ...
            <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> <img src="{{ asset(Auth::user()->profile_pic) }}" class="user-image rounded-circle shadow" alt=""> <span class="d-none d-md-inline">{{ Auth::user()->first_name }}</span> </a>
